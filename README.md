...
当前为 v0.5 开发阶段。v0.4 已完成 KTS 中间表生成、证据展示和 B 套模板行项对齐；v0.5 的重点是把中间表推进为可复核、可编辑、可保存的工作流。
...
本项目按小步迭代推进。当前分支中的开发重点是推进 v0.5：

- 将 KTS 中间表变成可逐项确认、修改和备注的复核工作流。
- 让自动结果的可信度和证据基础更直观。
- 为后续 DOCX 导出使用人工确认结果做结构准备。

后续版本方向：

- v0.5：KTS 逐项复核、证据复核和人工确认体验。
- v0.6：DOCX 导出。
- 后续：更多法律工作台能力。
